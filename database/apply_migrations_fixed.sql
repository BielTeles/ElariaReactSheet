-- ===================================================================
-- APLICAR MIGRAÇÕES DO SISTEMA DE CAMPANHAS (VERSÃO CORRIGIDA)
...
-- Função auxiliar para verificar se usuário é membro da campanha
...
-- Políticas para combat_trackers (CORRIGIDAS)
...
-- Políticas para campaign_sessions (CORRIGIDAS)
